...
static const struct myoption opts[] = 
  ...
  { 
	...
	{ "dhcp-immortal", 0, 0, LOPT_DHCP_IMMORTAL },
    { NULL, 0, 0, 0 }
  };
...
static struct {
  ...
  { LOPT_DHCP_IMMORTAL, OPT_DHCP_IMMORTAL, NULL, gettext_noop("Keep DHCP hostname valid at all times."), NULL },
  { 0, 0, NULL, NULL, NULL }
}; 
